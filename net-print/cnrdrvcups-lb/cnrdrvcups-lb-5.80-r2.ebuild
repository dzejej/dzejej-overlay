...
PATCHES=( "${FILESDIR}"/replace_incorrect_int_with_char.patch )
...
src_install() {
	...
	dosym ../../../$(get_libdir)/../lib/cups/filter/pdftocpca /usr/libexec/cups/filter/pdftocpca
	dosym ../../../$(get_libdir)/../lib/cups/filter/rastertoufr2 /usr/libexec/cups/filter/rastertoufr2
